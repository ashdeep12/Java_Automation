...
public class Sample_String {
	public static void main(String args[]) {
        ...
        System.out.println("Index of character 's' after 3 index: " + str_Sample.indexOf('s', 3));//the 3rd index s s 
        ...
        System.out.println("Index of substring 'is' form index:" + str_Sample.indexOf("is", 6));
    }
}
